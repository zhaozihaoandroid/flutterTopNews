...
class WebviewManager {
    ...
    WebviewManager(final Activity activity) {
        ...
        WebViewClient webViewClient = new WebViewClients();
        ...
        webView.setWebChromeClient(new WebChromeClient()
        {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                System.out.println("onProgress"+newProgress);
                Map<String, Object> data = new HashMap<>();
                data.put("getProgress",newProgress);
                FlutterWebViewPlugin.channel.invokeMethod("getProgress",data);
